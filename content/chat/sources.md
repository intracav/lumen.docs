---
title: "Where It Gets Its Info"
description: "Every answer includes sources you can check. Here's how to read them and verify what Lumen tells you."
weight: 5
---

Lumen always shows its work. After every answer, you'll see a **"Sources"** link that tells you exactly which guidelines, studies, or databases the answer came from &mdash; and how closely each one matched your question. Think of it as the bibliography at the end of a paper.
...
Click this chip to expand the list of sources inline, or click **"View in panel"** to open them in the side panel for a detailed view.

## Reading Source Cards
...
Depending on which knowledge toggles you have enabled, sources can come from:
